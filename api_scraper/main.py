...
# ── Grossiste helpers — module partagé avec le runner (grossiste_parse.py) ────
from grossiste_parse import (_norm_grossiste_labo, _parse_grossiste_bytes,
                             _parse_grossiste_detail_bytes, _merge_paliers,
                             _merge_grossiste_stats)
...
def _parse_fse_bank_sync(user_id: str, storage_path: str = "", xlsx_bytes: bytes = None, user_token: str = "", reset: bool = False) -> dict:
    ...
    # Intermédiaires de paiement : règlent POUR LE COMPTE d'un labo (Pharmedigroupe
    ...
    _PAYER_KEYS = [("PHARMEDI", "PHARMEDI"), ("PHARMADI", "PHARMEDI")]
    ...
    def _identify_labo(libelle: str) -> str | None:
        ...
        # apparaît parfois après le nom du payeur, ex. « VIR PHARMEDIGROUPE - ZYDUS … »).
